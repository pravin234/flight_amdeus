...
<body>
    ...
    <script>
    // Define bookFlight function globally
    // function bookFlight(flightOfferData) {
    //     alert(JSON.stringify(flightOfferData));


    //     // Make a call to the Flight Offers Pricing API
    //     $.ajax({
    ...
    //             // Handle the response from the Pricing API
...
function bookFlight(flightOfferData) {
    // Alert the original flightOfferData for debugging purposes
    // alert(JSON.stringify(flightOfferData));

    // Create the request body with dynamic flight offers
    var requestBody = {
        "data": {
            "type": "flight-offers-pricing",
            "flightOffers": flightOfferData  // Assuming flightOfferData is an array of flight offers
        }
    }; 
