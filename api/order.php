         ...
         [
            ...
            "documents" => [
               [
                  ...
                  "birthPlace" => "Pune", 
                  "issuanceLocation" => "Pune", 
                  "issuanceDate" => "2022-04-14", 
                  "number" => "00000000", 
...
if (isset($orderData["data"])) {
    ...
    $orderLogJson = json_encode($orderData);

    // Inserting order details into the 'orders' table
    $sqlOrders = "INSERT INTO orders (order_id,user_id, queuing_office_id, booking_date, remarks, order_log) 
                  VALUES ('$orderId', $user_id,'$queuingOfficeId', '$bookingDate', '$remarks', '$orderLogJson')";
