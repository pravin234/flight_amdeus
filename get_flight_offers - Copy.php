...
function bookFlight($flightOffersData, $accessToken) {
    try {
        $api_url = 'https://test.api.amadeus.com/v1/shopping/flight-offers/pricing';

        // Prepare the request body
        $request_body = json_encode($flightOffersData);
        ...
        // Example:
        if (isset($api_response['data']) && isset($api_response['data']['type']) && $api_response['data']['type'] === 'flight-offers-pricing') {
            echo 'Flight booked successfully!';
        } else {
            echo 'Error booking flight.';
        }
